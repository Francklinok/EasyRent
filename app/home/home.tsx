...
const Home = () => {
  ...
  // Fonction corrigée pour la navigation selon structure de dossiers
          ...
          renderItem={({ item }: { item: ItemType }) => (
            ...
            <View className="bg-white/90 rounded-3xl shadow-2xl mb-6 mt-6 p-1 overflow-hidden">
              ...
              <View className="p-5">
                ...
                {/* Bouton Voir Plus */}
                <TouchableOpacity 
                  className="bg-blue-400 from-purple-500 to-pink-500 py-3 rounded-xl items-center active:opacity-90 shadow-lg"

...
export class QRCodeGenerator {
  ...
  static decryptContractQRData(encryptedData: string): any {
    try {
      const secretKey = 'mySuperSecretKey123!';
...
export const QRCodeComponent = ({ data }: { data: string }) => {
...
//     // Return the first 8 characters of the hex digest as our checksum
...
//     // Create a reproducible pattern based on the data

...
const ServiceFilters: React.FC<ServiceFiltersProps> = ({
  ...
  const categories = [
    ...
    { value: ServiceCategory.PROPERTY_MANAGEMENT, label: 'Gestion locative', icon: 'business' },
    { value: ServiceCategory.CONSTRUCTION, label: 'Construction', icon: 'hammer' },
    { value: ServiceCategory.RENOVATION, label: 'Rénovation', icon: 'build' },
    { value: ServiceCategory.AGRICULTURE, label: 'Agriculture', icon: 'leaf-outline' },
    { value: ServiceCategory.UTILITIES, label: 'Services publics', icon: 'flash' },
    { value: ServiceCategory.WASTE_MANAGEMENT, label: 'Gestion déchets', icon: 'trash' },
    { value: ServiceCategory.PEST_CONTROL, label: 'Dératisation', icon: 'bug' },
    { value: ServiceCategory.HEALTHCARE_HOME, label: 'Santé à domicile', icon: 'medical' },
    { value: ServiceCategory.CHILDCARE_HOME, label: 'Garde d\'enfants', icon: 'happy' },
    { value: ServiceCategory.ELDERCARE_HOME, label: 'Aide seniors', icon: 'accessibility' },
    { value: ServiceCategory.TRANSPORT_LOGISTICS, label: 'Transport', icon: 'car' },
    { value: ServiceCategory.INSPECTION, label: 'Inspection', icon: 'search' },
    { value: ServiceCategory.LEGAL_ADMIN, label: 'Juridique', icon: 'document-text' },
    { value: ServiceCategory.EMERGENCY, label: 'Urgence', icon: 'alert-circle' },
    { value: ServiceCategory.ECO_SERVICES, label: 'Écologique', icon: 'earth' },
    { value: ServiceCategory.HOSPITALITY_SERVICES, label: 'Hôtellerie', icon: 'bed' },
    { value: ServiceCategory.OFFICE_SERVICES, label: 'Services bureau', icon: 'briefcase' },
    { value: ServiceCategory.COMMERCIAL_SERVICES, label: 'Services commerciaux', icon: 'storefront' },
    { value: ServiceCategory.OTHER, label: 'Autre', icon: 'ellipsis-horizontal' },
  ];
